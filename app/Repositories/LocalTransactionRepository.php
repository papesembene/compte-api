...
/**
 * Repository pour les transactions en base locale (Render PostgreSQL).
 *
 * Implémente TransactionRepositoryInterface pour la DB principale.
 */
class LocalTransactionRepository implements TransactionRepositoryInterface
{
    /**
